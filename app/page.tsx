      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
            ...
            and internalize concepts, quotes, and knowledge you&apos;ve collected.
          </p>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          <div className="p-6 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Import your study materials and automatically extract concepts,
              quotes, and key information.
            </p>
          </div>
